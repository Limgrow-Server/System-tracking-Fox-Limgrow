...
const iosReviewMappingSummarySelect = {
  appName: true,
  bundleId: true,
  id: true,
  status: true,
...
export function getIosReviewMappingSummariesByIds(mappingIds: string[]) {
...
export function getIosReviewMappingSummaryById(mappingId: string) {
